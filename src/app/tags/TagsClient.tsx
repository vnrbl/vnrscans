...
export type TagsInitialData = {
  genres?: TagGenre[];
  tags?: TagItem[];
};

export function TagsClient({ initialData }: { initialData: TagsInitialData }) {
  // Hydrate from server-prefetched data; refresh in the background.
