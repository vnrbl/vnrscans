...
export const CANONICAL_PROFILE_BADGES: Array<{
  ...
  {
    name: "Chronos Distortion Monarch",
    description: "Read 100 chapters in a single day",
    icon: "🌀",
    requirement_type: "daily_chapters",
    requirement_value: 100,
    badge_color: "#EF4444",
  ...
  {
    name: "Seraphic Light Sovereign",
    description: "Maintain a 200-day reading streak",
    icon: "👑",
    requirement_type: "reading_streak",
  ...
  {
    name: "Demon Slaying Sword God",
    description: "Read 2000+ chapters",
    icon: "🗡️",
    requirement_type: "chapters_read",
