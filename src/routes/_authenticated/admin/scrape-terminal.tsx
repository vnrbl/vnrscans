...
import { $runCloudScrape } from "@/lib/api/scraper.functions";
import { supabase } from "@/integrations/supabase/client";

export const Route = createFileRoute("/_authenticated/admin/scrape-terminal")({
  component: ScrapeTerminal,
});
