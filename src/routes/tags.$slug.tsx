      ...
      <div className="container mx-auto px-8 md:px-12 lg:px-16 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold" style={{ color: tag.data.color }}>
                {tag.data.name}
              </h1>
          ...
          {tag.data.description && (
            <p className="mt-4 text-muted-foreground">{tag.data.description}</p>
          )}
        </div>
        ...
        <div>
          ...
          {series.data && series.data.length === 0 && (
            <div className="rounded-lg border border-border/40 bg-card p-8 text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold">No titles yet</h3>
