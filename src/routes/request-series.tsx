...
export const Route = createFileRoute("/request-series")({
  head: () => ({
    meta: [
      { title: "Request a Series - vnrscans" },
      {
        name: "description",
        content:
          "Request manga, manhwa, manhua, or novels to be added to the vnrscans library.",
      },
    ],
  }),
  component: RequestSeriesPage,
});
