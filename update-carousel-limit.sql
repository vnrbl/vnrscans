...
-- Update the trigger function to allow 20 items instead of 10
...
BEGIN
  IF NEW.is_active = true THEN
    IF (SELECT COUNT(*) FROM public.carousel_items 
        ...
        AND id != COALESCE(NEW.id, gen_random_uuid())) >= 20 THEN
...
DO $$ 
BEGIN
  RAISE NOTICE '✅ Carousel limit updated to 20 items!';
END $$;
