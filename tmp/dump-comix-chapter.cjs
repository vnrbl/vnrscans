...
async function run() {
  ...
  fs.writeFileSync('tmp/comix-chapter.html', content);
  console.log('Saved tmp/comix-chapter.html, length:', content.length);
  console.log('Title:', await page.title());
  console.log('Body text (first 500):', (await page.evaluate(() => document.body.innerText)).slice(0, 500));
