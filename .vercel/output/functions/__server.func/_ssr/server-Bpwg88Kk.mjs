...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DoPHqjDR.mjs");
...
const manifest = {
  "2a2c8d7a9b0346fc1b4a261ed3bf46d16a8edec9b9183bbdab6cbc028283eb72": {
    functionName: "$extractImagesFromUrl_createServerFn_handler",
    importer: () => import("./scraper.functions-B9dsBdYK.mjs")
  },
  "8d447e795f623d885b1641fa727ec02e5d9d52a0c5d865fe4e835a94e7be9d3f": {
    functionName: "$extractChaptersFromUrl_createServerFn_handler",
    importer: () => import("./scraper.functions-B9dsBdYK.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-1xbLZGbP.mjs").then((n) => n.r),
    import("./start-qp5CAGxZ.mjs"),
