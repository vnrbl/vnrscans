...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bl1AAJoh.mjs");
...
const manifest = {
  "2a2c8d7a9b0346fc1b4a261ed3bf46d16a8edec9b9183bbdab6cbc028283eb72": {
    ...
    importer: () => import("./scraper.functions-BvrD5lLg.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DABr79Tj.mjs").then((n) => n.r),
    import("./start-C29pl73a.mjs"),
